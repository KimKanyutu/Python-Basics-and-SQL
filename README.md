...
This repository contains basics of python array and SQL joins

### Python arrays
In the python task, the first cell is to find the sum of an array.
The second part requires a user prompt to;
1. Specify number of array elements
2. Input array values
It then finds the sum of the inputted array values.

### SQL
This SQL joins code is in reference to the sql question:
